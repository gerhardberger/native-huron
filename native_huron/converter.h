...
#ifndef NATIVE_HURON_CONVERTER_H_
#define NATIVE_HURON_CONVERTER_H_
...
struct Converter<void*> {
  static v8::Local<v8::Value> ToV8(v8::Isolate* isolate, void* val) {
    return HURON_UNDEFINED(isolate);
  }
};
...
struct Converter<std::vector<T> > {
  static v8::Local<v8::Value> ToV8(v8::Isolate* isolate,
    ...
    v8::Local<v8::Array> result(
        HURON_ARRAY_NEW(isolate, static_cast<int>(val.size())));
...
#endif  // NATIVE_HURON_CONVERTER_H_
